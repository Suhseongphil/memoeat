...
- [o] `api/summarize.js` 파일 생성
- [o] Claude API 키 환경 변수 설정
- [o] CORS 설정
- [o] `vercel.json` 설정 파일 생성
...
- [o] axios + cheerio 설치 (이미 설치됨)
- [o] HTML 파싱 및 본문 추출 함수
- [o] 메타 정보 추출 (title, description)
- [o] 불필요한 태그 제거 (script, style, nav 등)

### 4.4 유튜브 자막 추출

- [o] youtube-transcript 설치 (이미 설치됨)
- [o] 비디오 ID 추출 함수
- [o] 자막 가져오기 함수 (한국어/영어/자동생성)
- [o] 자막 없을 시 에러 처리
- [o] 텍스트 길이 제한 (50,000자)

### 4.5 Claude API 연동

- [o] Anthropic SDK 설치 (이미 설치됨)
- [o] 링크 타입별 프롬프트 작성
  - [o] 유튜브 프롬프트 (요리 영상 → 재료+조리순서, 일반 영상 → 핵심 포인트)
  - [o] 웹페이지 프롬프트 (핵심 포인트)
- [o] API 호출 및 응답 처리
- [o] 에러 핸들링
- [o] Claude 3.5 Sonnet 모델 사용
...
- [o] LinkModal 컴포넌트
  ...
  - [o] ESC 키로 닫기
  - [o] 엔터키로 요약 실행
- [o] Editor에 "링크 요약" 버튼 추가
- [o] API 호출 로직 (개발/프로덕션 환경 자동 감지)
- [o] 요약 결과 에디터에 삽입 (타임스탬프 포함)
- [o] `link_url`, `link_type` 저장

### 4.7 링크 정보 표시

- [o] 링크 타입 아이콘 표시 (YouTube/Web)
- [o] 원본 링크 버튼 (새 탭에서 열기)

### 4.8 문서화

- [o] `PHASE4_SETUP.md` 설정 가이드 작성
  - [o] API Key 발급 방법
  - [o] 로컬 개발 환경 설정
  - [o] Vercel 배포 시 환경 변수 설정
  - [o] 에러 처리 가이드
